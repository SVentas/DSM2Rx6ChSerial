...
export LoadConfig_dsm2rx6chserial
export _LoadConfig_dsm2rx6chserial
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_dsm2rx6chserial
	lcall	LoadConfigTBL_dsm2rx6chserial_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration dsm2rx6chserial
;
;    Load configuration registers for dsm2rx6chserial.
...
;               CUR_PP
;
_LoadConfig_dsm2rx6chserial:
 LoadConfig_dsm2rx6chserial:
    RAM_PROLOGUE RAM_USE_CLASS_4
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_dsm2rx6chserial_Bank0
    mov     X, <LoadConfigTBL_dsm2rx6chserial_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_dsm2rx6chserial_Bank1
    mov     X, <LoadConfigTBL_dsm2rx6chserial_Bank1
